...
const routes: Routes = [
  ...
  { path: 'perg2', component: Pergunta2Component },
  { path: 'perg3', component: Pergunta3Component },
  { path: 'perg4', component: Pergunta4Component },
  { path: 'perg5', component: Pergunta5Component },
  { path: 'perg6', component: Pergunta6Component },
  { path: 'perg7', component: Pergunta7Component },
  { path: 'perg8', component: Pergunta8Component },
  { path: 'perg9', component: Pergunta9Component },
  { path: 'perg10', component: Pergunta10Component },
  { path: 'perg11', component: Pergunta11Component },
  { path: 'perg12', component: Pergunta12Component },
  { path: 'perg13', component: Pergunta13Component },
  { path: 'perg14', component: Pergunta14Component },
  { path: 'perg15', component: Pergunta15Component },
  { path: 'perg16', component: Pergunta16Component },
  { path: 'perg17', component: Pergunta17Component },
  { path: 'perg18', component: Pergunta18Component },
];
